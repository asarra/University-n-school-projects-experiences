...
/**
 * Encapsulates relevant information about a board field (tile).
 * A tile knows where on the board it is located and which player occupies it with how many dices.
 */
