...
import diceWarsLib.exceptions.DiceGameException;
...
public abstract class FieldGenerator {
    ...
    private final void validate() {
        ...
        if (!(playersOk && fieldsOk && dicesOk)) {
            System.out.println(playersOk);
            System.out.println(fieldsOk);
            System.out.println(avgDices);
            System.out.println(dicesOk);
