...
void __attribute__((weak)) keyPressed(int key);
void __attribute__((weak)) keyReleased(int key);
void __attribute__((weak)) mouseMoved(int x, int y );
void __attribute__((weak)) mouseDragged(int x, int y, int button);
void __attribute__((weak)) mousePressed(int x, int y, int button);
void __attribute__((weak)) mouseReleased(int x, int y, int button);
void __attribute__((weak)) mouseEntered(int x, int y);
void __attribute__((weak)) mouseExited(int x, int y);
void __attribute__((weak)) windowResized(int w, int h);
void __attribute__((weak)) dragEvent(ofDragInfo dragInfo);
void __attribute__((weak)) gotMessage(ofMessage msg);
